...
const monasteries = [
  ...
  },
  {
    ...
    description: "Sacred monastery perched on a hilltop with breathtaking valley views",
    duration: "30 min",
    rating: 4.7,
    visitors: "1.5k",
    languages: ["English", "Hindi"],
    highlights: ["Sacred Chorten", "Valley Views", "Prayer Flags", "Meditation Halls"],
    image: "/tashiding-monastery-hilltop-prayer-flags-valley-vi.jpg",
    panorama: "/placeholder.svg?height=400&width=800&text=360°+Tashiding+Sacred+Chorten",
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold mb-4">Explore More Monasteries</h3>
